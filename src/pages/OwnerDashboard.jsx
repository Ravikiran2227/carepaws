...
// function getCompatibilityScore(pet, carer) {
//   let score = 0;

//   if (!pet || !carer) return 0;

//   if (carer.preferredPets?.includes(pet.type)) score += 3;

//   if (carer.experience?.includes(pet.type)) score += 2;

//   if (pet.medical && carer.experience?.includes("special")) score += 2;
